<div id="menu" role="navigation">
    <ul class="navigation list-unstyled" id="demo">
        ...
        <a href="/api/view-travel" class="logo mr-0">
            <h1 class="text-center">MTP</h1>
        </a>
        ...
        <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
            <a href="/api/view-travel">
                <span class="mm-text ">Travel Package</span>
                <span class="menu-icon"><i class="im im-icon-Building"></i></span>
            </a>
        </li>

        <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
            <a href="/api/view-order">
                <span class="mm-text ">Order</span>
                <span class="menu-icon"><i class="im im-icon-Bookmark"></i></span>
            </a>
        </li>
