...
// Travel Package Route
Route::middleware(['web'])->group(function () { 
    Route::post('add-travel', 'TravelController@addTravelPackage')->name('add-travel');
    Route::get('view-travel', 'TravelListController@getTravelList')->name('view-travel');
    Route::get('view-order', 'OrderController@getOrderList')->name('view-order');
});
